...
def image_insert(docx, rand_file, image, end_xml)
  ...
  while (width > 680) || (height > 790) # fits nicely into word
    width -= (width / 20)
    height -= (height / 20)
  end
  image_file.close
  ...
  docu_rels = read_from_zip(rand_file, 'word/_rels/document.xml.rels')
  ...
  archive_modify(rand_file, docu_rels, 'word/_rels/document.xml.rels')
